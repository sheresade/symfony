...
// Returns the private 'App\Repository\CarteBancaireRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CarteBancaireRepository.php';

return $this->privates['App\\Repository\\CarteBancaireRepository'] = new \App\Repository\CarteBancaireRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
